...
namespace SP.Engine.Runtime
{
    public static class SpanExtensions
    {
        ...
        {
            return BinaryPrimitives.ReadInt64BigEndian(span.CheckedSlice(offset, sizeof(long)));
        }

        public static ushort ReadUInt16(this ReadOnlySpan<byte> span, int offset)
        {
            return BinaryPrimitives.ReadUInt16BigEndian(span.CheckedSlice(offset, sizeof(ushort)));
        }

        public static uint ReadUInt32(this ReadOnlySpan<byte> span, int offset)
        {
            return BinaryPrimitives.ReadUInt32BigEndian(span.CheckedSlice(offset, sizeof(uint)));
        }

        public static int ReadInt32(this ReadOnlySpan<byte> span, int offset)
        {
            return BinaryPrimitives.ReadInt32BigEndian(span.CheckedSlice(offset, sizeof(int)));
        }
