...
public static class RefsDataWriter
{
    public static void WriteRefFile(RefTableSchema schema, RefTableData data, string path)
    {
        var w = new NetWriter();
    ...
    public static async Task WriteRefFileAsync(
