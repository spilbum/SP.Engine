...
public sealed class CheckClientReq : IRpcRequest<CheckClientRes>
{
    int IRpcRequest<CheckClientRes>.MsgId => ResourceMsgId.CheckClientReq;
...
public sealed class SyncServerListReq : IRpcRequest<SyncServerListRes>
{
    int IRpcRequest<SyncServerListRes>.MsgId => ResourceMsgId.SyncServerListReq;
...
public sealed class RefreshResourceServerReq : IRpcRequest<RefreshResourceServerRes>
{
    int IRpcRequest<RefreshResourceServerRes>.MsgId => ResourceMsgId.RefreshResourceServerReq;
}
