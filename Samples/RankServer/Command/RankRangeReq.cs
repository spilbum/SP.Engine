...
public class RankRangeReq : CommandBase<GameServerPeer, G2RProtocolData.RankRangeReq>
{
    protected override void ExecuteCommand(GameServerPeer context, G2RProtocolData.RankRangeReq protocol)
    {
