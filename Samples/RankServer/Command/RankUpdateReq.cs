...
public class RankUpdateReq : CommandBase<GameServerPeer, G2RProtocolData.RankUpdateReq>
{
    protected override void ExecuteCommand(GameServerPeer context, G2RProtocolData.RankUpdateReq protocol)
    {
