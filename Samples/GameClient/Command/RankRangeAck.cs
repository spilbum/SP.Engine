...
public class RankRangeAck : BaseCommand<GameClient, G2CProtocolData.RankRangeAck>
{
    protected override void ExecuteProtocol(GameClient context, G2CProtocolData.RankRangeAck protocol)
    {
