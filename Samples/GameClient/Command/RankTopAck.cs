...
public class RankTopAck : BaseCommand<NetworkClient, G2CProtocolData.RankTopAck>
{
    protected override void ExecuteProtocol(NetworkClient context, G2CProtocolData.RankTopAck protocol)
    {
