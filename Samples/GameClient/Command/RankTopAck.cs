...
public class RankTopAck : BaseCommand<Client, G2CProtocolData.RankTopAck>
{
    protected override Task ExecuteCommand(Client context, G2CProtocolData.RankTopAck protocol)
    {
