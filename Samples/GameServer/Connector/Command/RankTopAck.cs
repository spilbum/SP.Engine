...
public class RankTopAck : CommandBase<RankConnector, R2GProtocolData.RankTopAck>
{
    protected override void ExecuteCommand(RankConnector context, R2GProtocolData.RankTopAck protocol)
    {
