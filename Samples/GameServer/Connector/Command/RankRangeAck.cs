...
public class RankRangeAck : CommandBase<RankConnector, R2GProtocolData.RankRangeAck>
{
    protected override void ExecuteCommand(RankConnector context, R2GProtocolData.RankRangeAck protocol)
    {
