...
public class RankMyReq : CommandBase<GamePeer, C2GProtocolData.RankMyReq>
{
    protected override void ExecuteCommand(GamePeer context, C2GProtocolData.RankMyReq protocol)
    {
