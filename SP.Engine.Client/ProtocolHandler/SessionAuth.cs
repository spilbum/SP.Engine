...
namespace SP.Engine.Client.ProtocolHandler
{
    ...
    public class SessionAuth : BaseProtocolHandler<S2CEngineProtocol.Data.SessionAuthAck>
    {
        protected override void ExecuteProtocol(NetPeer session,S2CEngineProtocol.Data.SessionAuthAck protocol)
        {
