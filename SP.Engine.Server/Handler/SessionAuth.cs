...
internal class SessionAuth<TPeer> : BaseEngineHandler<Session<TPeer>, C2SEngineProtocol.Data.SessionAuthReq>
    where TPeer : BasePeer, IPeer
{
    protected override void ExecuteProtocol(Session<TPeer> session, C2SEngineProtocol.Data.SessionAuthReq protocol)
    {
        ...
        {
            var authAck = new S2CEngineProtocol.Data.SessionAuthAck { ErrorCode = errorCode };
