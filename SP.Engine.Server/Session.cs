...
namespace SP.Engine.Server
{
        ...
        where TPeer : BasePeer, IPeer
    {
        ...
        public void OnPing(DateTime sentTime, int latencyAvgMs, int latencyStddevMs)
        {
            ...
            TryInternalSend(new S2CEngineProtocol.Data.Pong { SentTime = sentTime, ServerTime = DateTime.UtcNow });
        }
        ...
        public void SendCloseHandshake()
        {
            ...
            TryInternalSend(new S2CEngineProtocol.Data.Close());
        }
        
        internal void SendMessageAck(long sequenceNumber)
        {
            TryInternalSend( new S2CEngineProtocol.Data.MessageAck { SequenceNumber = sequenceNumber });
        }
